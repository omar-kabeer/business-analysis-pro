# BABOK Technique Index

Maps each of the 50 BABOK v3 techniques to the Business Analysis OS skill that owns it and the template that produces it, so any skill can point here to find the right technique and asset. Full technique descriptions are in `skills/business-analysis/references/babok-knowledge-areas.md`.

| # | Technique | Owning skill(s) | Template(s) |
| --- | --- | --- | --- |
| 1 | Acceptance and Evaluation Criteria | requirements, quality | user-story-epic; requirement-quality-review |
| 2 | Backlog Management | product-owner | user-story-epic |
| 3 | Balanced Scorecard | strategy | future-state-definition |
| 4 | Benchmarking and Market Analysis | market-research | |
| 5 | Brainstorming | elicitation | workshop-plan |
...
| 16 | Decision Analysis | strategy | |
| 17 | Decision Modelling | data-analysis, process-modelling | |
...
| 28 | Metrics and Key Performance Indicators | data-analysis, product-manager | |
| 29 | Mind Mapping | elicitation | |
| 30 | Non-Functional Requirements Analysis | requirements | nfr-specification |
