...
Plan version: 1.1.0
Plan status: Phase 2 in progress (Batch 2.1: 10 KA5 rubrics)
...
| 2 | KA5, KA6 rubrics (some also templates) | 22 | in-progress (2.1-2.3: 22 rubrics, 6 templates) |
...
| 6 | KA11 perspective rubrics | 47 | not-started |
