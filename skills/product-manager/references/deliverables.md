# Product Deliverables and Artefacts

The artefacts a PM produces across the lifecycle, mapped to audience, purpose, phase, and the OS template that backs each. Produce the right one for the decision at hand.
...
| Artefact | Audience | Purpose | Phase | Template |
| --- | --- | --- | --- | --- |
| Opportunity solution tree | Product trio | Link outcomes to opportunities, solutions, experiments | Discovery | opportunity-solution-tree |
| PRD or feature spec | Design, engineering | Scope, goals, personas, requirements, edge cases, acceptance criteria | Delivery | prd |
| Insights repository | Product, design | Tagged, weighted synthesis of interviews, tickets, surveys | Continuous | (data-analysis; candidate template) |
